...
var or__4328__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__4328__auto__)){
return or__4328__auto__;
} else {
var or__4328__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__4328__auto____$1)){
return or__4328__auto____$1;
} else {
var or__4328__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__4328__auto____$2)){
return or__4328__auto____$2;
} else {
var or__4328__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__4328__auto____$3)){
return or__4328__auto____$3;
} else {
...
var n__5213__auto__ = a.length;
var i = (0);
while(true){
if((i < n__5213__auto__)){
var c_5691 = (a[i]);
if(cljs.core.truth_((c_5691["cljsIsDirty"]))){
(c_5691["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__4907__auto__,writer__4908__auto__,opt__4909__auto__){
return cljs.core._write.call(null,writer__4908__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__5695 = c;
var G__5695__$1 = (((G__5695 == null))?null:(G__5695["props"]));
if((G__5695__$1 == null)){
return null;
} else {
return (G__5695__$1["argv"]);
}
});
...
var G__5697_5698 = (c["cljsRatom"]);
if((G__5697_5698 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__5697_5698);
}
