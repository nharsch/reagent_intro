...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__4907__auto__,writer__4908__auto__,opt__4909__auto__){
return cljs.core._write.call(null,writer__4908__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__4328__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__4328__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__4328__auto__)){
return or__4328__auto__;
} else {
...
var G__5728 = o;
(G__5728[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
while (G__5730__i < G__5730__a.length) {G__5730__a[G__5730__i] = arguments[G__5730__i + 0]; ++G__5730__i;}
  args = new cljs.core.IndexedSeq(G__5730__a,0);
} 
...
var old_5732 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_5732))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_5732)].join(''):class$));
} else {
}
...
if(cljs.core.truth_((function (){var and__4316__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__5735 = jsprops;
(G__5735["defaultValue"] = value);

(G__5735["onChange"] = ((function (G__5735,v,value,on_change){
return (function (p1__5733_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__5733_SHARP_);
});})(G__5735,v,value,on_change))
);
...
var vec__5737 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__5737,(0),null);
var id = cljs.core.nth.call(null,vec__5737,(1),null);
var class$ = cljs.core.nth.call(null,vec__5737,(2),null);
...
var temp__4659__auto__ = (function (){var G__5739 = cljs.core.meta.call(null,v);
if((G__5739 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__5739);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__5741_5742 = v;
var G__5741_5743__$1 = (((G__5741_5742 == null))?null:reagent.impl.template.key_from_vec.call(null,G__5741_5742));
if((G__5741_5743__$1 == null)){
} else {
(jsprops["key"] = G__5741_5743__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__5746 = cljs.core.meta.call(null,argv);
if((G__5746 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__5746);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__5747 = (((jsprops == null))?{}:jsprops);
(G__5747["key"] = key);
...
var n__5213__auto___5748 = a.length;
var i_5749 = (0);
while(true){
if((i_5749 < n__5213__auto___5748)){
(a[i_5749] = reagent.impl.template.as_element.call(null,(a[i_5749])));
...
var a = cljs.core.into_array.call(null,s);
var n__5213__auto___5751 = a.length;
var i_5752 = (0);
while(true){
if((i_5752 < n__5213__auto___5751)){
var val_5753 = (a[i_5752]);
if((cljs.core.vector_QMARK_.call(null,val_5753)) && ((reagent.impl.template.key_from_vec.call(null,val_5753) == null))){
(o["no-key"] = true);
} else {
}

(a[i_5752] = reagent.impl.template.as_element.call(null,val_5753));

var G__5754 = (i_5752 + (1));
i_5752 = G__5754;
continue;
} else {
}
...
var G__5756 = (cljs.core.count.call(null,argv) - first_child);
switch (G__5756) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__5756){
